...
gamesCard.innerHTML = gamesCount;
...
const displayStr = 
`A total of ${'$' + amountRaised.toLocaleString('en-US')} has been raised for 
${gamesCount + ' ' + (gamesCount > 1 ? 'games' : 'game')}. Currently, 
${unfundedGamesCount + ' ' + (unfundedGamesCount > 1 ? 'games remain' : 'game remains')} 
unfunded. We need your help to fund these amazing games!
`;


// create a new DOM element containing the template string and append it to the description container
const templateParagraph = document.createElement('p');
templateParagraph.innerHTML = displayStr;
descriptionContainer.appendChild(templateParagraph);
...
topFundedElement.innerHTML = firstGame.name;
firstGameContainer.appendChild(topFundedElement);

// do the same for the runner up item
const secondTopFundedElement = document.createElement('p');
secondTopFundedElement.innerHTML = secondGame.name;
secondGameContainer.appendChild(secondTopFundedElement);